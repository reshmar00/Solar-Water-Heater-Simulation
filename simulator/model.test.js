...
//         expect(() => model.calculateRadiationAtSurface('1000', 0.5)).toThrowError('Input must be a number');
//         expect(() => model.calculateRadiationAtSurface(1000, '0.5')).toThrowError('Input must be a number');
//         expect(() => model.calculateRadiationAtSurface('1000', '0.5')).toThrowError('Input must be a number');
//     });
//
//     it('should throw an error for Infinity input', () => {
//         expect(() => model.calculateRadiationAtSurface(Infinity, 0.5)).toThrowError('Input value cannot be infinity');
//         expect(() => model.calculateRadiationAtSurface(1000, Infinity)).toThrowError('Input value cannot be infinity');
//         expect(() => model.calculateRadiationAtSurface(Infinity, Infinity)).toThrowError('Input value cannot be infinity');
//     });
// });
//
...
//
//     it('should throw an error for Infinity input', () => {
//         expect(() => model.calculateRb(180, Infinity)).toThrowError('Input value must be an number between 15 and 75');
//     });
// });