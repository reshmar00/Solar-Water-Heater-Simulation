const controller = {
    ...
    startGraphUpdate: function(dayOfYear, Tstart, volume, timeStep, tilt, timeOfDay) {
        ...
        let intervalId = setInterval(() => {
            ...
            let E = model.calculateQcoll(dayOfYear,
                             tilt, timeOfDay, Tambient, Told);
            ...
            model.graphData.xArray.push(currentTime);
            model.graphData.yArray.push(Tnew);
